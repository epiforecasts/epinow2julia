...
#'   estimation. Set to `NULL` to use back-calculation instead.
#' @param backcalc A list of options as generated by [backcalc_opts()]
#'   defining the back-calculation settings.
#' @param gp A list of options as generated by [gp_opts()] defining the
#'   Gaussian process settings. Set to `NULL` to disable.
#' @param obs A list of options as generated by [obs_opts()] defining the
#'   observation model.
#' @param stan A list of options as generated by [stan_opts()] defining
#'   the inference settings (samples, warmup, chains, etc.).
#' @param id A character string used to identify the model run.
