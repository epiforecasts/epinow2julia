...
#'   (`AutoForwardDiff()`; `AutoReverseDiff(compile = false)` and
#'   `AutoReverseDiff(compile = true)` are ~1.5× and ~2× faster
#'   respectively on fixed-delay models but currently fail on
#'   uncertain delays/truncation). Examples:
